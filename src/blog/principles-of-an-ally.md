...
- **They should be in leadership positions, not you.** When you want to form an initiative around supporting an underrepresented group, you need to find someone from that group to serve as the leader of that group. In addition, you should be ready to do the legwork to make that group successful while staying in the shadows. So case and point, I love the work that [VueVixens](https://vuevixens.org/) is doing and wanted to start a chapter here in DC, but it would have been ridiculous for me to be the chapter leader. So while I was ready to help with whatever needs to be done to make the chapter successful, I needed a partner-in-crime to truly make the initiative successful.
