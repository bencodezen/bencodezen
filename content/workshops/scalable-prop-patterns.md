...
<form netlify-honeypot="seek-field" name="workshop-interest" method="POST" data-netlify="true" class="mb-5">
  <label class="hidden">Don't fill out if you're a human: <input name="seek-field-2" type="text"></input></label>
  <label class="form-label" for="workshop-interest-email">
    Email Address
    <input class="form-input" type="email" id="workshop-interest-email" name="workshop-interest-email"></input>
  </label>
